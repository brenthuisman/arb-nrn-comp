...
def run_nrn(setup, model, duration, v_init, temperature):
    ...
    neuron_cell.create_synapse(neuron_cell.dendrites[0], "AMPA").stimulate(start=200, number=2, interval=7)
    neuron_cell.create_synapse(neuron_cell.dendrites[0], "NMDA").stimulate(start=200, number=2, interval=7)
    neuron_time = p.time
